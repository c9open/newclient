...
module.exports = function(session, options) {
    ...
    session.install({
        ...
        {
            "tar.gz": {
                "url": "https://raw.githubusercontent.com/c9open/install/master/packages/sqlite3/linux/sqlite3.tar.gz",
    ...
    session.install({
        ...
        "tar.gz": { 
            "url": "https://raw.githubusercontent.com/c9open/install/master/packages/extend/c9-vfs-extend.tar.gz",
            "target": "~/.c9"
        }
    });
